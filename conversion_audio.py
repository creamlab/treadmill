...
for trial_id, sound_file in enumerate(liste_sons):
	...
	myCommand = "ffmpeg -i " + r"C:/Users/qdecu/Downloads/piano/" + sound_file + " -af loudnorm,aformat=s16,silenceremove=start_periods=1:start_threshold=-40dB,afade=out:st=0.9:d=0.1,afade=in:st=0:d=0.05 -to 1.5 " + r"C:/Users/qdecu/Downloads/piano/" + son_converti1
	os.system(myCommand)
